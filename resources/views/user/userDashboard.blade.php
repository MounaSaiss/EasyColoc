        ...
        <main class="flex-1 p-6">
            <header class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="w-8 h-8 bg-zinc-900 rounded-lg border border-zinc-800 flex items-center justify-center text-xs font-bold text-[#059669]">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="bg-white rounded-2xl p-5 text-black relative overflow-hidden group">
                    <p class="text-[9px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Dépenses Global (Feb)
                    </p>
                    <h3 class="text-3xl font-black">{{ number_format($unpaidAmount ?? 0, 2, ',', ' ') }} €</h3>
                    <div class="absolute -right-2 -bottom-2 text-zinc-100 opacity-20 text-6xl font-black">€</div>
                </div>

                <div
                    class="bg-[#064e3b] rounded-2xl p-5 text-white flex flex-col justify-between shadow-lg border border-green-700">
                    <div>
                        <p class="text-[9px] font-bold text-green-300 uppercase tracking-widest mb-2"> 🟢 Ma Colocation
                            Active </p>
                        ...
                        @if ($activeColo = Auth::user()->colocations->firstWhere('type', 'active'))
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="inline-block px-2 py-0.5 bg-green-600/30 text-green-200 text-[10px] font-bold rounded-full uppercase">
                                    Active
                                </span>
                            </div>
                        @else
