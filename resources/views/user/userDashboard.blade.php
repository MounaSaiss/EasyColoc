...
<head>
    ...
    <style>
        ...
        body { font-family: 'Plus Jakarta Sans', sans-serif; background-color: #0a0a0a; font-size: 14px; }
    </style>
</head>
    ...
    <div class="min-h-screen flex">
        <aside class="w-60 border-r border-zinc-900 hidden md:flex flex-col p-5 gap-6 bg-[#0a0a0a]">
            ...
            <nav class="space-y-1">
                ...
                <a href="#" class="flex items-center gap-3 text-zinc-500 hover:text-white px-3 py-2 rounded-lg text-xs font-semibold transition">
        ...
        <main class="flex-1 p-6">
            <header class="flex justify-between items-center mb-8">
                ...
                <div class="flex items-center gap-3">
                    <button class="bg-white text-black px-4 py-2 rounded-lg text-xs font-bold hover:bg-[#059669] hover:text-white transition shadow-md">
                        + Dépense
                    </button>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                ...
                <div class="bg-white rounded-2xl p-5 text-black relative overflow-hidden group">
                    <p class="text-[9px] font-bold text-zinc-400 uppercase tracking-widest mb-1">Dépenses (Feb)</p>
                    <h3 class="text-3xl font-black">0,00 €</h3>
                    <div class="absolute -right-2 -bottom-2 text-zinc-100 opacity-20 text-6xl font-black">€</div>
                </div>

                <div class="bg-[#064e3b] rounded-2xl p-5 text-white flex flex-col justify-between">
                    <div>
                        <p class="text-[9px] font-bold text-green-300 uppercase tracking-widest mb-1">Ma Colocation</p>
                        <h3 class="text-sm font-bold leading-tight">Aucune active</h3>
                    </div>
                    <button class="mt-2 text-[10px] font-black border-b border-green-400 w-fit hover:text-green-300">Rejoindre</button>
                </div>
            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-zinc-900/50">
                            <tr>
                                <td colspan="4" class="py-10 text-center text-zinc-700 text-xs italic">
                                    Aucune donnée.
                                </td>
                            </tr>
                        </tbody>
