        ...
        <main class="flex-1 p-6">
            ...
            @if (isset($colocations) && $colocations->count() > 0)
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    @foreach ($colocations as $colocation)
                        ...
                        <div
                            class="bg-[#111111] border border-zinc-800 rounded-2xl p-5 hover:border-[#059669] transition-all">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div
                                        class="w-10 h-10 rounded-xl bg-[#064e3b] flex items-center justify-center font-bold text-sm">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            @if ($membership->pivot->role === 'owner')
                                                <span
                                                    class="text-[9px] bg-yellow-500/20 text-yellow-400 px-2 py-1 rounded-full font-bold uppercase flex items-center gap-1 w-fit">
                                                    <!-- Crown -->
                                            ...
                                            @else
                                                <span
                                                    class="text-[9px] bg-blue-500/20 text-blue-400 px-2 py-1 rounded-full font-bold uppercase flex items-center gap-1 w-fit">
                                                    <!-- User -->
                                                    <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                                                        <path
                                ...
                                @else
                                    ...
                                    @else
                                        <span
                                            class="text-[9px] bg-green-500/20 text-green-400 px-2 py-1 rounded-full font-bold uppercase">
                                            Active
                                        </span>
                                    @endif
                                @endif
                            ...
                            <div class="flex justify-between items-center mt-6 text-xs text-zinc-400">
                                ...
                                @if ($colocation->type !== 'cancelled' && $membership->pivot->leftAt === null)
            ...
            @else
                <div class="mt-20 flex flex-col items-center justify-center text-center">
                    ...
                    <div
                        class="w-16 h-16 bg-zinc-900/50 rounded-2xl flex items-center justify-center mb-6 border border-zinc-800">
                        <!-- Ton SVG ici -->
                    </div>
